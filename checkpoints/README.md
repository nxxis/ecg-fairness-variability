...
| Reweighted 1D-CNN        | `Reweighted_1D-CNN`        |
...
Example: `checkpoints/Reweighted_1D-CNN_seed777.pth`
...
model.load_state_dict(torch.load("checkpoints/Reweighted_1D-CNN_seed777.pth", map_location="cpu"))
model.eval()
```
